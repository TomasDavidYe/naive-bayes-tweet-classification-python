...
counts_in_mentions = feature_matrix.dot(ones)
counts_in_mentions = counts_in_mentions.sort_values(by=['Frequency'], ascending=False)
counts_in_mentions.to_csv('counts_in_mentions.csv')
